...
def main():
    ...
    determiner = get_determiner(2).capitalize()
    noun = get_noun(2)
    ...
    print(f"{determiner} {noun} {verb} {prep_phrase}{punctuation}")
...
def get_punctuation():
    """Return either a period or exclamation point to insert
