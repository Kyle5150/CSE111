def main():
    ...
    pformula = parse_formula(formula, ptable)

    molar_mass = compute_molar_mass(pformula, ptable)

    # print(compute_molar_mass(pformula, ptable)
...
def compute_molar_mass(symbol_quantity_list, periodic_table):
    ...
    for e in symbol_quantity_list:
        symbol, quantity = e
        e_name = make_periodic_table()[symbol][0]
        print(f"{quantity} {e_name} atoms")
        # print(symbol, quantity)
        mass = make_periodic_table()[symbol][1]
        # print(mass)
        total_e_mass = mass * quantity
        total_mass += total_e_mass
    return total_mass
